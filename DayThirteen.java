...
public class DayThirteen{
    ...
    DayThirteen(String playerOneName, int health1, int supplies1, int food1, int symptoms1, int money1, int x1, int y1, boolean infected1,
    ...
    public void day13(){
        ...
        //Antiviral developed!!!
        JOptionPane.showMessageDialog(null, "The long promised antiviral medication that the FDA fast tracked has " +
                "finally been produced in significant quantities.\n In a day's time, the federal government will begin a competent " +
                "and timely distribution effort that promises \nto drastically reduce the strain on hospitals. This will increase the survivability \nof the virus for both those lucky " +
                "enough to receive the medication \nas well as those who would otherwise be unable to have room in the ICU without the freed up beds.");
        ...
        DayFourteen dayfourteen = new DayFourteen(playerOne.getPlayerOneName(), playerOne.getHealth(), playerOne.getSupplies(), playerOne.getFood(),
